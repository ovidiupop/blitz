...
use Yii;
use common\models\Produs;
use common\models\search\Produs as ProdusSearch;
...
class ProdusController extends Controller
{
    ...
    /**
     * Displays a single Produs model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Produs model.
    ...
    /**
     * Deletes an existing Produs model.
