      ...
      <?php $this->beginBody(); ?>
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img alt="" src="../assets/images/margo.png">
                        </a>
                    </div>
        ...
        <div class="section full-width-portfolio" style="border-top:0; border-bottom:0; background:#fff;">
                ...
                <ul id="portfolio-list" data-animated="fadeIn">
                    <li>
                        <img src="../assets/images/Portfolio-1/1.png" alt="" />
                    ...
                    <li>
                        <img src="../assets/images/Portfolio-1/9.png" alt="" />
                        <div class="portfolio-item-content">
                            <span class="header">Monocle issue 69</span>
                            <p class="body">web develpment, design</p>
                        </div>
                    ...
                    <li>
                        <img src="../assets/images/Portfolio-1/10.png" alt="" />
                        <div class="portfolio-item-content">
                            <span class="header">Monocle issue 69</span>
                            <p class="body">web develpment, design</p>
                        </div>
                    ...
                    <li>
                        <img src="../assets/images/Portfolio-1/11.png" alt="" />
                        <div class="portfolio-item-content">
                            <span class="header">Monocle issue 69</span>
                            <p class="body">web develpment, design</p>
                        </div>
                    ...
                    <li>
                        <img src="../assets/images/Portfolio-1/12.png" alt="" />
                        <div class="portfolio-item-content">
                            <span class="header">Monocle issue 69</span>
                            <p class="body">web develpment, design</p>
                        </div>
...
<div class="col-md-4">
  ...
  <!-- End Testimonials Carousel -->
        ...
        <div id="parallax-one" class="parallax" style="background-image:url(../assets/images/parallax/bg-02.jpg);">
